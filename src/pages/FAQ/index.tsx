            ...
            >
              ...
              <Accordion open={open === 1} icon={<Icon id={1} open={open} />}>
                ...
                <AccordionBody className="py-[13px] px-[16px] text-[14px] !text-white">
                  ...
                  Off-Chain NFTs (ONFTs) from one blockchain to another using
              ...
              <Accordion open={open === 2} icon={<Icon id={2} open={open} />}>
                ...
                <AccordionBody className="py-[13px] px-[16px] text-[14px] !text-white">
                  ONFT stands for Off-Chain NFT (Non-Fungible Token). Unlike
              ...
              <Accordion open={open === 6} icon={<Icon id={6} open={open} />}>
                ...
                <AccordionBody className="py-[13px] px-[16px] text-[14px] !text-white">
                  If your ONFT collection isn't listed on our platform, it means
                  that it hasn't been integrated yet. You can request to add
                  your collection by clicking on the "Add Your Own Collection"
                  button and filling out the necessary information. Our team
                  will review your application, and if approved, your collection
                  will be added to the platform for traversal.
                </AccordionBody>
              </Accordion>
