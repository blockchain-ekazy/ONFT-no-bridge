    ...
    <>
      <Wrapper className="relative w-screen">
        ...
        <div
          ...
          style={{ background: 'url("/assets/imgs/galleryhero.png")' }}
        >
          <Space />
          <ContentWrapper>
            <div className="relative m-auto grid md:grid-cols-2 w-[90%]">
              {/* style={{ width: "90%" }} */}
              <div>
                <HeaderTitle>
                ...
                <HeaderText className="my-8">
                  {/* The purpose of ONFT Traverse is to provide a user-friendly
                  experience for moving an ONFT or group of ONFTs from one chain
                  to another. ONFT Traverse leverages LayerZero's protocol to
                  allow simple and secure cross-chain transfers without directly
                  interacting with a smart contract or block explorer. */}
                  The place that provides a user-friendly experience for moving
                  an ONFT or group of ONFTs from one chain to another.
                </HeaderText>
              </div>
            </div>
          </ContentWrapper>
